...
IqWampCallbackRegistrations::IqWampCallbackRegistrations(QObject *parent) :
    IqWampRegistrations<IqWampCallbackRegistration>(parent)
{
}

QSharedPointer<IqWampCallbackRegistration> IqWampCallbackRegistrations::create(int id,
...
{
    QSharedPointer<IqWampCallbackRegistration> registration = QSharedPointer<IqWampCallbackRegistration>::create(id, procedure, callback, errorCallback);
